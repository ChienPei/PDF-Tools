...
def extract_pages_based_on_topics(source_pdf, target_pdf, text_criteria_list):
...
def main():
    ...
    titles_of_pages = extract_pages_based_on_topics(source_pdf_path, target_pdf_path, text_criteria_list)
